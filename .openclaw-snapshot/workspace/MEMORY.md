...
- OpenClaw branch: `claude/general-session-W7a7w`
- Memory search is broken — needs an embedding API key (openai/google/voyage) configured
- Kamil's Telegram: @DigitalAvenue, id: 455442541
